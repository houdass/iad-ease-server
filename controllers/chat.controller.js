...
exports.newConversation = function(req, res, next) {
    ...
    conversation.save((err, newConversation) => {
        ...
        message.save((err, newMessage) => {
            ...
            res.status(200).json({ message: 'Conversation started!' + newMessage, conversationId: conversation._id });
            return next();
        });
    });
};
...
exports.sendReply = function(req, res, next) {
    ...
    reply.save((err, sentReply) => {
        ...
        res.status(200).json({ message: 'Reply successfully sent!' + sentReply });
        return next;
    });
};
